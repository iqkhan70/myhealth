...
{
    /// <inheritdoc />
    public partial class AddPatientSystemWithDataMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Create a default patient for existing data
            migrationBuilder.Sql(@"
                INSERT INTO Patients (FirstName, LastName, Email, DateOfBirth, Gender, CreatedAt, LastLoginAt, IsActive)
                VALUES ('Demo', 'Patient', 'demo@mentalhealth.app', NOW() - INTERVAL 30 YEAR, 'Other', NOW(), NOW(), 1);
            ");

            // Update existing journal entries to reference the default patient
            migrationBuilder.Sql(@"
                UPDATE JournalEntries 
                SET PatientId = (SELECT Id FROM Patients WHERE Email = 'demo@mentalhealth.app' LIMIT 1)
                WHERE PatientId = 0;
            ");
