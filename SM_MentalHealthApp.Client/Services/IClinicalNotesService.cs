...
public interface IClinicalNotesService
{
    ...
    Task<PagedResult<ClinicalNoteDto>> ListPagedAsync(int skip, int take, int? patientId = null, int? doctorId = null, int? serviceRequestId = null, string? searchTerm = null, string? noteType = null, string? priority = null, bool? isIgnoredByDoctor = null, DateTime? createdDateFrom = null, DateTime? createdDateTo = null, CancellationToken ct = default);
