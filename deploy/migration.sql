...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20251127142131_AddUserRequestTable') THEN
    ...
    CREATE TABLE `UserRequests` (
        ...
        `MobilePhone` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
        `Status` int NOT NULL,
...
BEGIN
    ...
    CREATE INDEX `IX_UserRequests_MobilePhone` ON `UserRequests` (`MobilePhone`);
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20251127142131_AddUserRequestTable', '9.0.9');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20251127161104_AddReasonToUserRequest') THEN

    ALTER TABLE `UserRequests` ADD `Reason` varchar(1000) CHARACTER SET utf8mb4 NOT NULL DEFAULT '';
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20251127161104_AddReasonToUserRequest', '9.0.9');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20251129161350_EncryptDateOfBirth') THEN

    ALTER TABLE `Users` ADD `DateOfBirthEncrypted` varchar(500) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Users` MODIFY COLUMN `DateOfBirthEncrypted` varchar(500) CHARACTER SET utf8mb4 NOT NULL DEFAULT '';
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20251129161350_EncryptDateOfBirth', '9.0.9');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20251129162652_EncryptUserRequestDateOfBirth') THEN

    ALTER TABLE `UserRequests` ADD `DateOfBirthEncrypted` varchar(500) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `UserRequests` MODIFY COLUMN `DateOfBirthEncrypted` varchar(500) CHARACTER SET utf8mb4 NOT NULL DEFAULT '';
...
BEGIN
    ...
    ALTER TABLE `UserRequests` DROP COLUMN `DateOfBirth`;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20251129162652_EncryptUserRequestDateOfBirth', '9.0.9');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20251202013810_AddAccidentFieldsToUserRequestAndUser') THEN

    ALTER TABLE `UserRequests` DROP INDEX `IX_UserRequests_MobilePhone`;
...
BEGIN
    ...
    ALTER TABLE `Users` ADD `AccidentAddress` varchar(500) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Users` ADD `AccidentDate` datetime(6) NULL;
...
BEGIN
    ...
    ALTER TABLE `Users` ADD `AccidentDetails` varchar(2000) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Users` ADD `AdditionalNotes` varchar(2000) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Users` ADD `DateOfAccident` datetime(6) NULL;
...
BEGIN
    ...
    ALTER TABLE `Users` ADD `DoctorsInformation` varchar(1000) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Users` ADD `LawyersInformation` varchar(1000) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Users` ADD `MobilePhoneEncrypted` varchar(500) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Users` ADD `PoliceCaseNumber` varchar(100) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Users` ADD `Race` varchar(100) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Users` ADD `RoadConditions` varchar(200) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Users` ADD `VehicleDetails` varchar(1000) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `UserRequests` ADD `AccidentAddress` varchar(500) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `UserRequests` ADD `AccidentDate` datetime(6) NULL;
...
BEGIN
    ...
    ALTER TABLE `UserRequests` ADD `AccidentDetails` varchar(2000) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `UserRequests` ADD `AdditionalNotes` varchar(2000) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `UserRequests` ADD `Age` int NULL;
...
BEGIN
    ...
    ALTER TABLE `UserRequests` ADD `DateOfAccident` datetime(6) NULL;
...
BEGIN
    ...
    ALTER TABLE `UserRequests` ADD `DoctorsInformation` varchar(1000) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `UserRequests` ADD `LawyersInformation` varchar(1000) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `UserRequests` ADD `MobilePhoneEncrypted` varchar(500) CHARACTER SET utf8mb4 NOT NULL DEFAULT '';
...
BEGIN
    ...
    ALTER TABLE `UserRequests` ADD `PoliceCaseNumber` varchar(100) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `UserRequests` ADD `Race` varchar(100) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `UserRequests` ADD `RoadConditions` varchar(200) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `UserRequests` ADD `VehicleDetails` varchar(1000) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20251202013810_AddAccidentFieldsToUserRequestAndUser', '9.0.9');
